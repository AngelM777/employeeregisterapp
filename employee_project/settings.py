"""
Django settings for employeeregisterapp project.
...
ALLOWED_HOSTS = ['localhost', 'employee-register-app.herokuapp.com']
...
ROOT_URLCONF = 'employeeregisterapp.urls'
...
WSGI_APPLICATION = 'employeeregisterapp.wsgi.application'
